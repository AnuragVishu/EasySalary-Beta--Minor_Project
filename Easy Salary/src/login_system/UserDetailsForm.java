...
public class UserDetailsForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(52, 47, 47));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("NanumGothic", 1, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().equals("") || jTextField2.getText().equals("") || jTextField3.getText().equals("") || jTextField4.getText().equals("") || jTextField5.getText().equals("") || jTextField6.getText().equals("") || jTextField7.getText().equals("")){
            ...
            try{
                ...
                String sql = "insert into foo.user_details(name, age, blood_group, address, emp_id, ph_no, grade) values ('"+s7+"', '"+s1+"', '"+s2+"', '"+s3+"', '"+s4+"', '"+s5+"', '"+s6+"')";
                stm.executeUpdate(sql);
                
                UserDetailsDisplayForm ud = new UserDetailsDisplayForm();
                ud.setVisible(true);
                this.dispose();
